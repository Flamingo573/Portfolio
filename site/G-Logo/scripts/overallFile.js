...
function initialize() {
    ...
    var myCenter = new google.maps.LatLng(47.228642, 39.716000);
...
var FixedMenu = function () {
    ...
    _createClass(FixedMenu, [{
        key: 'listenerScroll',
        value: function listenerScroll(event) {
            var scroll = window.pageYOffset || document.documentElement.scrollTop;
            if (scroll > this.scrollPlay) this.menu.classList.add('active');else this.menu.classList.remove('active');
